layui.use(['table', 'element'], function () {
    ...
    table.on('edit(file)', function (obj) {
        var value = obj.value;
        var data = obj.data;
        BMY.ajax(BMY.url.prefix + "/file/edit", obj.data, function (json) {
    ...
    table.on('tool(file)', function (obj) {
        ...
        if (obj.event === 'del') {
            layer.confirm('真的删除么?', function (index) {
                BMY.ajax(BMY.url.prefix + "/file/delete", {id: data.id}, function (json) {
