...
public class NoteController extends BaseController {
    ...
    public R show(@PathVariable("id") Long id, Boolean show) {
        return builder("修改状态").exec(() -> noteRepository.updateById(show, id) == 1);
    }
